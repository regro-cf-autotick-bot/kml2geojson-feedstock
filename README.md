...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/kml2geojson-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11770&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/kml2geojson-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `kml2geojson` can be installed with:

```
conda install kml2geojson
```

It is possible to list all of the versions of `kml2geojson` available on your platform with:
